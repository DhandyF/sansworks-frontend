...
<template>
  <div>
    ...
    <Modal v-model="showForm" :title="editing ? 'Edit Tailor' : 'Add Tailor'" size="md" contentClass="h-[80vh]" :closeOnOverlay="false">
    ...
    <Modal v-model="showDeleteModal" title="Delete Tailor" size="sm" :closeOnOverlay="false">
