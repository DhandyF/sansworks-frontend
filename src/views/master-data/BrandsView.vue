...
<template>
  <div>
        ...
        <Table :columns="columns" :rows="items" :pagination="pagination" @page-change="fetchData">
          ...
          <template #actions="{ row }">
            <div class="flex items-center gap-1">
              <button @click="router.push({ name: 'brand-detail', params: { id: row.id } })" class="p-1.5 rounded-lg text-primary-600 hover:bg-primary-50 transition-colors cursor-pointer" title="View Detail">
    ...
    <Modal v-model="showForm" :title="editing ? 'Edit Brand' : 'Add Brand'" size="md" contentClass="h-[80vh]" :closeOnOverlay="false">
    ...
    <Modal v-model="showDeleteModal" title="Delete Brand" size="sm" :closeOnOverlay="false">
